...
<html>
  <head>
    <meta charset="utf-8">
    <title>New Stars - Early Childhood English Curiculum</title>
  ...
  <body>
    ...
    <header>
      ...
      <div id="logobar">
        <!-- main logo -->
        <img src="images/logo.png" alt="New Stars - Early Childhood English Curiculum" width="350" height="" />
        <!-- linove logo and slogan -->
        <div id="slogan">
          <img src="images/linove_logo.png" alt="Linove" width="94" height="23" />
...
<?php
	...
	if(isset($_POST['submit'])) {
	    ...
	    $subject = "Linove New Stars Website Form Submission";
	    ...
	    $message = $name . " (" . $phonetic . "), with the e-mail address " . $from . " wrote the following:" . "\n\n" . $form_message . "\n\n";
			...
			echo "\n";
			$desired_course = $_POST['facility-type'] ?? NULL;
			if ($desired_course) {
				$message .= "施設の種別:\n\n";
